...
describe('Calcular pacote correto para cada projeto', () => {
    ...
    test('Retorna pacote intermediário caso o númeor total de horas seja exatamento 100', () =>{
    ...
    test('Retorna pacote premium caso o número total de horas seja até 199', () => {
    ...
    test('Retorna pacote premium caso o númeor total de horas seja exatamento 200', () =>{
